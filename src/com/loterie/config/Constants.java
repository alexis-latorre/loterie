...
public interface Constants {
	...
	public static final String SELECT_JEU_PAR_JOUR_TIRAGE 					= "SELECT j FROM Jeu j WHERE j.jourDeTirage LIKE :jour";
	public static final String SELECT_JEU_DECLINAISONS_PAR_JEU 				= "SELECT d FROM JeuDeclinaison d WHERE d.jeu = :jeu";
	public static final String SELECT_JEU_DECLINAISONS			 			= "SELECT d FROM JeuDeclinaison d";
